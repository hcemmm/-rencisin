...
public class Yaprakdoner extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,yaprakdonerwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yaprakdoner);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.yaprakdoneryorum_alani);
        yorum_gonder = findViewById(R.id.yaprakdoneryorum_yap);
        yorumyap_profilresmi = findViewById(R.id.yaprakdonerkullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_yaprakdoneryorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.yaprakdonerharitagit);
        yaprakdonerwebegit = findViewById(R.id.yaprakdonerwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("YaprakDoner").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("yaprakd");
        db3.keepSynced(true);

        databaseReference =database.getReference("Yorumlar").child("yaprakd");


        yaprakdonerwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.yaprakdoner.com/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Hasan+Usta+Yaprak+D%C3%B6ner/@38.3472222,38.3147222,15z/data=!4m2!3m1!1s0x0:0xf262903dea898e14?sa=X&ved=2ahUKEwjwxaGttZfwAhUI6aQKHQx5BW0Q_BIwHXoECE0QBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Yaprakdoner.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Yaprakdoner.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Yaprak Döner");
