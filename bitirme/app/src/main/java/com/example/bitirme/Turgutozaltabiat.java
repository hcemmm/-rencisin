...
public class Turgutozaltabiat extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,tozaltabiatwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turgutozaltabiat);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.tozaltabiatyorum_alani);
        yorum_gonder = findViewById(R.id.tozaltabiatyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.tozaltabiatkullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_tozaltabiatyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.tozaltabiatharitagit);
        tozaltabiatwebegit = findViewById(R.id.tozaltabiatwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("TurgutOTabiatParki").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("TurgutOzalTabiatParki");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("TurgutOzalTabiatParki");


        tozaltabiatwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Turgutozaltabiat.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Turgutozaltabiat.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
