...
public class Hacibabaetsinan extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,hacibabawebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hacibabaetsinan);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.hacibabayorum_alani);
        yorum_gonder = findViewById(R.id.hacibabayorum_yap);
        yorumyap_profilresmi = findViewById(R.id.hacibabakullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_hacibabayorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.hacibabaharitagit);
        hacibabawebegit = findViewById(R.id.hacibabawebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("Hacibabasinan").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Hacibaba");
        db3.keepSynced(true);

        databaseReference =database.getReference("Yorumlar").child("Hacibaba");


        hacibabawebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/Haci-Baba-Sinan-Et-Lokantasi-406580589698842/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Hac%C4%B1+Baba+Et+Lokantas%C4%B1/@38.3510765,38.319417,15z/data=!4m2!3m1!1s0x0:0x7e56e5b44d98ec94?sa=X&ved=2ahUKEwihpNKPtZfwAhW9_7sIHb42BlEQ_BIwHnoECFIQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Hacibabaetsinan.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Hacibabaetsinan.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Hacı Baba R.");
