...
public class Hurriyetparki extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,hurriyetparkiwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurriyetparki);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.hurriyetparkiyorum_alani);
        yorum_gonder = findViewById(R.id.hurriyetparkiyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.hurriyetparkikullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_hurriyetparkiyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.hurriyetparkiharitagit);
        hurriyetparkiwebegit = findViewById(R.id.hurriyetparkiwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("Hurriyetparki").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Hurriyet");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("Hurriyet");


        hurriyetparkiwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://malatya.ktb.gov.tr/TR-186877/hurriyet-parki.html"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/H%C3%BCrriyet+Park%C4%B1/@38.3483791,38.3274481,15z/data=!4m2!3m1!1s0x0:0x9a0dca4af1c19f4f?sa=X&hl=tr&ved=2ahUKEwi3lK3uyZfwAhUK_aQKHXZNBwoQ_BIwFXoECDkQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Hurriyetparki.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Hurriyetparki.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Hürriyet Parkı");
