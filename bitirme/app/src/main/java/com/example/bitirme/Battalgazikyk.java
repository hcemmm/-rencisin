...
public class Battalgazikyk extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,battalwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_battalgazikyk);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.battalgaziyorum_alani);
        yorum_gonder = findViewById(R.id.battalgaziyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.battalgazikullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_battalgaziyorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.battalgaziharitagit);
        battalwebegit = findViewById(R.id.battalgaziwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("BattalgaziKYK").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Battalgazi");
        db3.keepSynced(true);

        databaseReference =database.getReference("Yorumlar").child("Battalgazi");


        battalwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/dir//Bulgurlu,+BATTALGAZ%C4%B0+KIZ+%C3%96%C4%9ERENC%C4%B0+YURDU+VE+BLOKLARI,+kanyon+caddesi+no:39%2F5,+44100+Battalgazi%2FMalatya/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x40763723171f5243:0xbc6766d1930c4a43?sa=X&ved=2ahUKEwiFjbGdhIPwAhWRwQIHHTVTDBsQ48ADMAB6BAgEEA8"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Battalgazikyk.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Battalgazikyk.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Battalgazi KYK");
