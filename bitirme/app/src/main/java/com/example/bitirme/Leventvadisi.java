...
public class Leventvadisi extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,leventvadisiwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leventvadisi);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.leventvadisiyorum_alani);
        yorum_gonder = findViewById(R.id.leventvadisiyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.leventvadisikullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_leventvadisiyorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.leventvadisiharitagit);
        leventvadisiwebegit = findViewById(R.id.leventvadisiwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("LeventVadisi").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Leventvadi");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("Leventvadi");


        leventvadisiwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.kulturportali.gov.tr/turkiye/malatya/gezilecekyer/levent-vadisi"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Levent+Vadisi+Seyir+Terasi/@38.4081782,37.9240067,15z/data=!4m2!3m1!1s0x0:0xa550764f73442c36?sa=X&hl=tr&ved=2ahUKEwjJ5J3iyJfwAhUDr6QKHTzuA7YQ_BIwIHoECEkQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Leventvadisi.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Leventvadisi.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Levent Vadisi");
