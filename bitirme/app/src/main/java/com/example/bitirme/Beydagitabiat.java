...
public class Beydagitabiat extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,beydagitabiatwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beydagitabiat);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.beydagitabiatyorum_alani);
        yorum_gonder = findViewById(R.id.beydagitabiatyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.beydagitabiatkullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_beydagitabiatyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.beydagitabiatharitagit);
        beydagitabiatwebegit = findViewById(R.id.beydagitabiatwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("BeydagiTabiatParki").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("BeydagiTabiat");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("BeydagiTabiat");


        beydagitabiatwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://beydagi.tabiat.gov.tr/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Beyda%C4%9F%C4%B1+Tabiat+Park%C4%B1/@38.3393041,38.3396415,15z/data=!4m5!3m4!1s0x0:0xd194730d5a020f61!8m2!3d38.3393041!4d38.3396415?hl=tr"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Beydagitabiat.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Beydagitabiat.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Beydağı Tabiat Parkı");
