...
public class KahtaliLahmacun extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,kahtaliwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kahtali_lahmacun);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.kahtaliyorum_alani);
        yorum_gonder = findViewById(R.id.kahtaliyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.kahtalikullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_kahtaliyorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.kahtaliharitagit);
        kahtaliwebegit = findViewById(R.id.kahtaliwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("KahtaliLamacun").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("kahtali");
        db3.keepSynced(true);

        databaseReference =database.getReference("Yorumlar").child("kahtali");


        kahtaliwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://menuburada.com/kahtali-kavurma-kofte-ferhadiye-malatya/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Kahtal%C4%B1+K%C3%B6fte+Kavurma/@38.3471213,38.3209641,15z/data=!4m5!3m4!1s0x0:0x3402732daf9cbdfb!8m2!3d38.3471213!4d38.3209641"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(KahtaliLahmacun.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(KahtaliLahmacun.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Kahtalı Lahmacun");
