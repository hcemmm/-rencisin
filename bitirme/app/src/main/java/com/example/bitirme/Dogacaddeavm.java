...
public class Dogacaddeavm extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,dogacaddewebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dogacaddeavm);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.dogacaddeyorum_alani);
        yorum_gonder = findViewById(R.id.dogacaddeyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.dogacaddekullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_dogacaddeyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.dogacaddeharitagit);
        dogacaddewebegit = findViewById(R.id.dogacaddewebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("DogaCaddeAvm").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("dogacadde");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("dogacadde");


        dogacaddewebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://doga.com.tr/projeler/doga-cadde-avm/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Do%C4%9Fa+Cadde/@38.3489278,38.3051689,15z/data=!4m2!3m1!1s0x0:0x2cbc468633ea9508?sa=X&hl=tr&ved=2ahUKEwjAnLXs4JTwAhVDpYsKHYOEA7sQ_BIwHXoECEYQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Dogacaddeavm.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Dogacaddeavm.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Doğa Cadde AVM");
