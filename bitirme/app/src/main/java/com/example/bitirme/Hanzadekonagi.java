...
public class Hanzadekonagi extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,hanzadekonagiwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hanzadekonagi);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.hanzadekonagiyorum_alani);
        yorum_gonder = findViewById(R.id.hanzadekonagiyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.hanzadekonagikullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_hanzadekonagiyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.hanzadekonagiharitagit);
        hanzadekonagiwebegit = findViewById(R.id.hanzadekonagiwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("HanzadeKonagi").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Hanzade");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("Hanzade");


        hanzadekonagiwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.hanzadekonagi.com/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Malatya+Hanzade+Kona%C4%9F%C4%B1/@38.3459033,38.3207921,17z/data=!3m1!4b1!4m5!3m4!1s0x407636c47e1f73dd:0x7eefac4bf4bf8da6!8m2!3d38.3459045!4d38.3229712?hl=tr"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Hanzadekonagi.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Hanzadekonagi.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Hanzde Konağı");
