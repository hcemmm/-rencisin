...
public class Malatyaparkavm extends AppCompatActivity {

    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,malatyaparkwebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malatyaparkavm);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.malatyaparkyorum_alani);
        yorum_gonder = findViewById(R.id.malatyaparkyorum_yap);
        yorumyap_profilresmi = findViewById(R.id.malatyaparkkullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_malatyaparkyorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.malatyaparkharitagit);
        malatyaparkwebegit = findViewById(R.id.malatyaparkwebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("MalatyaParkAvm").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("MalatyaPark");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("MalatyaPark");


        malatyaparkwebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.malatyapark.com.tr/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Malatya+Park+Al%C4%B1%C5%9Fveri%C5%9F+Merkezi/@38.3491747,38.2966427,15z/data=!4m2!3m1!1s0x0:0x422115c7a956ef04?sa=X&hl=tr&ved=2ahUKEwijzZnT35TwAhWyxIsKHd3cD38Q_BIwIXoECEoQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Malatyaparkavm.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Malatyaparkavm.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Malatya Park AVM");
