...
public class Coffemania extends AppCompatActivity {


    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit,coffemaniawebegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffemania);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.coffemaniayorum_alani);
        yorum_gonder = findViewById(R.id.coffemaniayorum_yap);
        yorumyap_profilresmi = findViewById(R.id.coffemaniakullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView_mpark = findViewById(R.id.recycler_coffemaniayorumgor);
        recyclerView_mpark.setHasFixedSize(true);
        recyclerView_mpark.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.coffemaniaharitagit);
        coffemaniawebegit = findViewById(R.id.coffemaniawebgit);
        ...
        db1 = database.getReference("Tumyorumlar").child("CoffeMania").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Coffemania");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("Coffemania");


        coffemaniawebegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent webintent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.coffeemania.com/"));
        ...
        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/place/Coffeemania/@38.345592,38.3218962,17z/data=!3m1!4b1!4m5!3m4!1s0x407636c4942a258d:0x9e4a40fcc799381b!8m2!3d38.3455776!4d38.3241788"));
    ...
    private void yorumsilbas(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Coffemania.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Coffemania.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Coffe Mania");
