...
public class Copycenter extends AppCompatActivity {
    TextView yorumdaki_ad;
    ImageView yorumyap_profilresmi;
    EditText yorum_alani;
    Button yorum_gonder,adresegit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_copycenter);

        yorumdaki_ad = findViewById(R.id.yorumdaki_adsoyad);
        yorum_alani = findViewById(R.id.copycenteryorum_alani);
        yorum_gonder = findViewById(R.id.copycenteryorum_yap);
        yorumyap_profilresmi = findViewById(R.id.copycenterkullanici_yorumpp);
        yorumkullanicilar = new Yorumkullanicilar();
        tumkullanicilar = new Tumkullanicilar();
        recyclerView = findViewById(R.id.recycler_copycenteryorumgor);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adresegit = findViewById(R.id.copycenterharitagit);
        ...
        db1 = database.getReference("Tumyorumlar").child("CopycenterKirtasiye").child(kullan_id);
        db2 = database.getReference("KYorumlar").child(kullan_id);
        db3 = database.getReference("Yorumlar").child("Copycenter");
        db3.keepSynced(true);


        databaseReference =database.getReference("Yorumlar").child("Copycenter");


        adresegit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent haritaintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/maps/dir//malatya+copy+center/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x40763779ea718eb7:0x556859fdb1961b0e?sa=X&ved=2ahUKEwjQjI2Z05TwAhWu3OAKHbKCCvoQ9RcwAHoECBMQBQ"));
    ...
    private void yorumsil(String yorum) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Copycenter.this);
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Copycenter.this, "Yorum Silindi", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void yorum_yap() {
        ...
        if (comment != null){
            ...
            yorumkullanicilar.setKonum("Copy Center");
